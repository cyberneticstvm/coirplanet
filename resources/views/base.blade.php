...
<head>
    ...
    <link rel="icon" type="image/png') }}" sizes="144x144" href="{{ asset('/assets/images/favicons/android-icon-144x144.png') }}">
                ...
                <div class="container">
                            ...
                            <div class="footer_widgets about_company light_color">
                                <div class="about_company_inner">
                                    <div class="content_box">
                                        <p class="color_white">
                                            We are a UK based company having our manufacturing unit in Kerala, the land of coconut, a state derived its name from coconut, India. Our products are purely natural coir geotextile, organic and natural coco peat, coco pods and mulch mat.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            ...
                            <div class="footer_widgets clearfix">
                                <ul class="list_items_new_box type_one ">
                                    <li>
                                        <a href="{{ route('about') }}" class="color_white">
                                ...
                                <div class="get_intouch_inrfo">
                                    <div class="foo_cont_inner">
                                        ...
                                        <div class="bottom">
                                            ...
                                            <div class="con_content">
                                                <h5> Mail Us :</h5>
                                                <a href="mailto:mail@coirplanet.com">mail@coirplanet.com</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 m-auto">
                            <div class="newsteller style_three">
                                <div class="content">
                                    <h2>Newsletter <br>
                                        Get Updates & Latest News</h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <div class="color_white">
                                © {{ date('Y') }} <a href="https://coirplanet.com"
                                    class="color_white">Coirplanet.</a> All Rights
                                Reserved.
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                                ...
                                <form class="contact-form" method="post" action="sendemail.php">
                                    ...
                                    <p>
                                        <label> Contact number<br />
                                            <input type="text" name="contact" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Contact Number with Country Code" />
                                            <br />
                            ...
                            <div class="abt_content">
                                ...
                                <div class="post_contet_modal">
                                    ...
                                    <div class="post_enable">
                                        ...
                                        <div class="modal_post_grid">
                                            <a href="blog-single.html">
                                                <img width="852" height="812" src="{{ asset('/assets/images/blog/blog-image-6.jpg') }}"
                                                    class="main_img wp-post-image" alt="img" />
                                            </a>
                                        </div>
                                        <div class="modal_post_grid">
                                            <a href="blog-single.html">
                                                <img width="852" height="812" src="{{ asset('/assets/images/blog/blog-image-5.jpg') }}"
                                                    class="main_img wp-post-image" alt="img" />
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="copright">
                                    © {{ date('Y') }} Coir Planet. All Rights Reserved.
                                </div>
                            </div>
                        </div>
                    </div>
